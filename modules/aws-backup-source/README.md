...
| <a name="input_terraform_role_arn"></a> [terraform\_role\_arns](#input\_terraform\_role\_arn)                                                                              | List of ARNs of Terraform roles used to deploy to account                                          | `string` | n/a | yes |
