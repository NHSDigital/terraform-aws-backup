...
class TestAuroraRestoreLambda(unittest.TestCase):
    def setUp(self):
        ...
        self.event_start_job = {
            ...
            'db_cluster_identifier': 'test-restore-cluster'
        }
        self.patcher_sleep = patch('restore_to_aurora.time.sleep', return_value=None)
    ...
    def test_start_job_and_completes_successfully(self):
        rest_mod = importlib.import_module('restore_to_aurora')
